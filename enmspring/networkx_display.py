...
class THY_Right_Base(THY_Base):
    ...
    def __init__(self, radius):
        ...
        self.name_list_1 = ['C6', 'C5', 'C4', 'N3', 'C2', 'N1']
        self.name_list_2 = ['C7', 'O4', 'O2']
        self.name_list = self.name_list_1 + self.name_list_2
    ...
    def get_branch(self, d_nodes):
        ...
        name = 'O4'
        d_nodes[name] = self.get_xy_by_radius(150, 2 * self.radius)
...
class ADE_Right_Base(THY_Base):
    ...
    def __init__(self, radius):
        ...
        self.name_list_1 = ['C5', 'C6', 'N1', 'C2', 'N3', 'C4']
        self.name_list_2 = ['N6']
        self.name_list_3 = ['N7', 'C8', 'N9']
        self.name_list = self.name_list_1 + self.name_list_2 + self.name_list_3
...
class GUA_Right_Base(THY_Base):
    ...
    def get_branch(self, d_nodes):
        ...
        name = 'N2'
        d_nodes[name] = self.get_xy_by_radius(210, 2 * self.radius)
